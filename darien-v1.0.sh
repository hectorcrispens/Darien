...
while [ -n "$1" ]; do # while loop starts
			...
			deploy)
				...
				echo "  ErrorLog ${APACHE_LOG_DIR}/error.log" >> default.conf
				echo "  CustomLog ${APACHE_LOG_DIR}/access.log combined" >> default.conf
				...
				echo "    Require all granted" >> default.conf
				echo "  </Directory>" >> default.conf
				echo "  ErrorLog ${APACHE_LOG_DIR}/error_test.log" >> default.conf
				echo "  CustomLog ${APACHE_LOG_DIR}/access_test.log combined" >> default.conf
				echo "</VirtualHost>" >> default.conf
				...
				while [ -n "$2" ]; do # while loop starts
							...
							-node)
								...
								echo "    volumes:" >> docker-compose.yml
								echo "      - ./App/:/home/node/app" >> docker-compose.yml
								echo "    expose:" >> docker-compose.yml
